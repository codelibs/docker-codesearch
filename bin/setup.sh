...
for fess_plugin in ${fess_plugins} ; do
  ...
  if [[ ${plugin_name} = "fess-theme-codesearch" ]] ; then
    ...
    unzip ${plugin_file} "view/*" -d ${base_dir}/data/fess/usr/share/fess/app/WEB-INF/view/codesearch
    rm -rf ${base_dir}/data/fess/usr/share/fess/app/css/codesearch/*
    unzip ${plugin_file} "css/*" -d ${base_dir}/data/fess/usr/share/fess/app/css/codesearch
    rm -rf ${base_dir}/data/fess/usr/share/fess/app/images/codesearch/*
    unzip ${plugin_file} "images/*" -d ${base_dir}/data/fess/usr/share/fess/app/images/codesearch
  fi
done
